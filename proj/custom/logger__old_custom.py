...
import pandas as pd
from .functions import checkData, get_badrows, checkLogic, mismatch
...
def logger(all_dfs):
    ...
    if 'minidot' in loggermeta['sensortype'].unique().tolist():
        args.update({
            ...
            "badrows": checkLogic(loggermeta[loggermeta['sensortype'] == 'minidot'], loggerm, groupcols, df1_name = "WQ_metadata", df2_name = "mDOT_data"), 
